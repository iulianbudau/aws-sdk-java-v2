...
/**
 * A path operand that refers to a <a href="http://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_AttributeValue.html" >binary set</a> attribute in DynamoDB;
 * used for building expressions.
 * <p>
...
public final class BS extends PathOperand {
    ...
    /**
     * Returns a <a href="http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.SpecifyingConditions.html#ConditionExpressionReference.Comparators"
     * >comparator condition</a> (that evaluates to true if the value of the current attribute is equal to the set of specified
     * values) for building condition expression.
     */
    ...
    /**
     * Returns a <a href="http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.SpecifyingConditions.html#ConditionExpressionReference.Comparators"
     * >comparator condition</a> (that evaluates to true if the value of the current attribute is not equal to the set of
     * specified values) for building condition expression.
     */
    ...
    /**
     * Returns an {@code FunctionCondition} object which represents an <a href=
     * "http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.Modifying.html" >contains(path, operand)</a>
     * function condition where path refers to that of the current path operand; used for building expressions.
     *
     * <pre>
     ...
     * </pre>
     *
     * @param value the value that will be used as the operand to the "contains" function condition.
     */
    ...
    /**
     * Returns an {@code AddAction} for build expression that would append the specified values to this binary set; or if the
     * attribute does not already exist, add the new attribute and the value(s) to the item.
     * <p>
    ...
    /**
     * Returns a {@code DeleteAction} for deleting the specified values from this binary set.
     */
    ...
    /**
     * Returns an {@code IfNotExistsFunction} object which represents an <a href=
     ...
     * </pre>
     *
     * @param defaultValue the default value that will be used as the operand to the if_not_exists function call.
     */
    public IfNotExistsFunction<BS> ifNotExists(byte[]... defaultValue) {
        return new IfNotExistsFunction<>(this, new LiteralOperand(
            new LinkedHashSet<>(Arrays.asList(defaultValue))));
    }
     ...
     * </pre>
     *
     * @param defaultValue the default value (of another binary set attribute) that will be used as the operand to the
