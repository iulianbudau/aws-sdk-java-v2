...
public final class ParenthesizedCondition extends Condition {
    ...
    /**
     * Returns a parenthesized condition for the given condition if the given condition is not already a parenthesized condition;
     * or the original condition otherwise.
     */
