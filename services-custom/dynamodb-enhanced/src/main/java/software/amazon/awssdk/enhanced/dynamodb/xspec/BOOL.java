...
/**
 * A path operand that refers to a <a href="http://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_AttributeValue.html" >boolean</a> attribute in DynamoDB;
...
public final class BOOL extends PathOperand {
     ...
     */
    public InCondition in(boolean... values) {
     ...
     */
    public InCondition in(Collection<Boolean> values) {
     ...
     * </pre>
     *
     * @param defaultValue the default value (of another boolean attribute) that will be used as the operand to if_not_exists
     *                     function call.
     */
