 ...
 * "http://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_AttributeValue.html" >string set</a> attribute in DynamoDB;
...
public final class SS extends PathOperand {
    ...
    /**
     * Returns an {@code FunctionCondition} object which represents a <a href=
     ...
     */
    public SetAction set(String... values) {
     ...
     */
    public SetAction set(SS source) {
        return new SetAction(this, source);
    }

    /**
     * Returns an {@code AddAction} for building expression that would append the specified values to this string set; or if
     * the attribute does not already exist, add the new attribute and the value(s) to the item.
     * <p>
    ...
    /**
     * Returns a {@code DeleteAction} for deleting the specified values from this string set.
     */
     ...
     * </pre>
     *
     * @param defaultValue the default value (of another string set attribute) that will be used as the operand to
