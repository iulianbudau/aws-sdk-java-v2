 ...
 * "http://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_AttributeValue.html" >number set</a> attribute in DynamoDB;
...
public final class NS extends PathOperand {
    ...
    /**
     * Returns an {@code AddAction} for building expression that would append the specified values to this number set; or if
     * the attribute does not already exist, adding the new attribute and the value(s) to the item.
     * <p>
    ...
    /**
     * Returns a {@code DeleteAction} for deleting the specified values from this number set.
     */
