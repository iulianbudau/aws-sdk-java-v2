...
/**
 * Represents an <a href= "http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.Modifying.html"
 * >if_not_exists(path, operand)</a> function in building expressions. If the item does not contain an attribute at the specified
 * path, then if_not_exists evaluates to operand; otherwise, it evaluates to path. You can use this function to avoid overwriting
 * an attribute already present in the item.
 * <p>
