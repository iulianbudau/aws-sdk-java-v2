 ...
 * "http://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_AttributeValue.html" >binary</a> attribute in DynamoDB; used
...
public final class B extends PathOperand {
    ...
    /**
     * Returns an <a href="http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.SpecifyingConditions.html#ConditionExpressionReference.Functions"
     ...
     */
    public InCondition inByteBufferList(Collection<ByteBuffer> values) {
     ...
     * @param values specified list of values. The number of values must be at least one and at most 100.
     */
    public InCondition inBytesList(Collection<byte[]> values) {
        List<LiteralOperand> list = values.stream().map(LiteralOperand::new).collect(Collectors.toCollection(LinkedList::new));
        return new InCondition(this, list);
    }
    ...
    /**
     * Returns a <a href="http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.SpecifyingConditions.html#ConditionExpressionReference.Comparators"
     * >comparator condition</a> (that evaluates to true if the value of the current attribute is equal to the specified value)
    ...
    /**
     * Returns a <a href="http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.SpecifyingConditions.html#ConditionExpressionReference.Comparators"
     * >comparator condition</a> (that evaluates to true if the value of the current attribute is not equal to the specified
    ...
    /**
     * Returns an {@code IfNotExists} object which represents an <a href="http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.Modifying.html" >if_not_exists(path,
     ...
     * </pre>
     *
     * @param defaultValue the default value (of another binary attribute) that will be used as the operand to the if_not_exists
     *                     function call.
     */
    ...
    /**
     * Returns a <a href="http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.SpecifyingConditions.html#ConditionExpressionReference.Functions"
