 ...
 * "http://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_AttributeValue.html" >list</a> attribute in DynamoDB; used
...
public final class L extends PathOperand {
    ...
    /**
     * Returns a {@code SetAction} for adding the value of evaluating the specified {@code ListAppend} function as an
     * attribute to an item. If this attribute already exists, it will be replaced by the new value.
     */
    ...
    /**
     * Returns an {@code ListAppend} for building expression that involves a <a href=
     * "http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.Modifying.html" >list_append(operand,
     * operand)</a> function for the purpose of adding the specified values to the current list attribute.
     *
     ...
     * Returns an {@code ListAppend} for building expression that involves a <a href=
     * "http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.Modifying.html" >list_append(operand,
     * operand)</a> function for the purpose of adding the specified list of values to that of the current list attribute.
     *
     ...
     * Returns an {@code ListAppend} for building expression that involves a <a href=
     * "http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.Modifying.html" >list_append(operand,
     * operand)</a> function for the purpose of adding the values of the specified list attribute to the current list attribute.
     *
     * @param that the specified list attribute whose values will be added to the current list attribute.
     */
