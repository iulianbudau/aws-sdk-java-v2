...
public class TransactGetItemsTest extends LocalDynamoDbSyncTestBase {
    ...
    public void getRecordsFromMultipleTables_withExtensionEnabled_doesNotThrowAndMatches() {
        ...
        DynamoDbEnhancedClient extensionClient = DynamoDbEnhancedClient.builder()
                                                                       ...
                                                                       .build();
        DynamoDbTable<Record1> extensionMappedTable1 = extensionClient.table(getConcreteTableName("table-name-1"), TABLE_SCHEMA_1);
        DynamoDbTable<Record2> extensionMappedTable2 = extensionClient.table(getConcreteTableName("table-name-2"), TABLE_SCHEMA_2);
        ...
        List<Document> results = extensionClient.transactGetItems(request);
        assertThat(results.size(), is(4));
