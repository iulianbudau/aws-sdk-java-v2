...
public class AsyncIndexScanTest extends LocalDynamoDbAsyncTestBase {
    ...
    public void scanAllRecordsDefaultSettings() {
        insertDocuments();
        Page<EnhancedDocument> page = drainPublisher(index.scan(), 1).get(0);
    ...
    public void scanAllRecordsWithFilter() {
        ...
        Expression expression = Expression.builder()
                                          ...
                                          .build();
        Page<EnhancedDocument> page = drainPublisher(index.scan(ScanEnhancedRequest.builder()
    ...
    public void scanLimit() {
        insertDocuments();
        List<Page<EnhancedDocument>> pages = drainPublisher(index.scan(r -> r.limit(5)), 3);
    ...
    public void scanExclusiveStartKey() {
        ...
        Page<EnhancedDocument> page = drainPublisher(index.scan(r -> r.exclusiveStartKey(startKey)), 1).get(0);
